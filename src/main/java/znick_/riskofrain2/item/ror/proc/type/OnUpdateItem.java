...
public interface OnUpdateItem {
	 ...
	 */
	public abstract void procOnUpdate(LivingUpdateEvent event, EntityData player, int itemCount);
	 ...
	 */
	public abstract boolean shouldProcOnUpdate(LivingUpdateEvent event, EntityData player, int itemCount);
}
