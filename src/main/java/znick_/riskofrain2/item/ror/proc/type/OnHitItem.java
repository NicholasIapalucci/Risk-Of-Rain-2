...
public interface OnHitItem {
	 ...
	 */
	public abstract void procOnHit(LivingAttackEvent event, EntityData player, EntityLivingBase enemy, int itemCount);
	 ...
	 */
	public abstract boolean shouldProcOnHit(LivingAttackEvent event, EntityData player, EntityLivingBase enemy, int itemCount);
