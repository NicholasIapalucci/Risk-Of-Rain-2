...
public class FireworksItem extends RiskOfRain2Item implements OnObjectInteractionItem, OnUpdateItem {
	...
	@Override
	public void procOnInteraction(ObjectInteractionEvent event, PlayerData player, int itemCount) {
	 ...
	 */
	private void shootFirework(PlayerData player, TileEntity tile, int itemCount) {
