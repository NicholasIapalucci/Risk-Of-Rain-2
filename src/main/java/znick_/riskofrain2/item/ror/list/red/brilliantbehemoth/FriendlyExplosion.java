 ...
 * break any blocks in the world. Used by items such as the brilliant behemoth that explode mobs.
 * 
 * @author zNick_
 */
public class FriendlyExplosion extends Explosion {
	...
	private void getFields() {
		this.maxExplosionSize = ObfuscationReflectionHelper.getPrivateValue(Explosion.class, this, "field_77289_h");
		this.world = ObfuscationReflectionHelper.getPrivateValue(Explosion.class, this, "worldObj");
		this.map = ObfuscationReflectionHelper.getPrivateValue(Explosion.class, this, "field_77288_k"); 
	}
	...
	public void doExplosionA() {
		...
		for (int i1 = 0; i1 < list.size(); ++i1) {
			...
			// Get the entity to handle 
			Entity entity = (Entity) list.get(i1);
			
			//Do not knockback or damage the entity that caused the explosion
			if (entity == this.exploder) continue;
			
			// Handle damage and knockback logic
