...
public class NonPlayerEntityData extends EntityData<EntityLivingBase> {
	...
	protected NonPlayerEntityData(EntityLivingBase entity) {
		super(checkEntity(entity));
	}
	
	private static EntityLivingBase checkEntity(EntityLivingBase entity) {
		if (entity == null) throw new NullPointerException("Cannot register data for a null entity!");
		if (entity instanceof EntityPlayer) throw new IllegalArgumentException("Cannot register player data as EntityData. Use PlayerData instead.");
		return entity;
	}
